package uk.co.compendiumdev.todomvc.page.loadablecomponent;
...
public class ApplicationPageStructuralLoadable extends LoadableComponent<ApplicationPageStructuralLoadable>{
